...
float  testFuncionsLlibre()
{
    ...
    cout << "Comment :=>>" << endl;
    cout << "Comment :=>>" << endl;
    cout << "Comment :=>> Iniciant test de la classe Biblioteca" << endl;
    cout << "Comment :=>> =====================================" << endl;
    cout << "Comment :=>>" << endl;
    cout << "Comment :=>> Afegint llibres amb el metode afegeixLlibre..." << endl;
    ...
    cout << "Comment :=>>" << endl;
    cout << "Comment :=>> Iniciant test del metode prestaLlibre" << endl;
    cout << "Comment :=>> =====================================" << endl;
    ...
    cout << "Comment :=>>" << endl;
    cout << "Comment :=>> Iniciant test del metode retornaLlibre (despres dels prestecs anteriors)" << endl;
    cout << "Comment :=>> ========================================================================" << endl;
