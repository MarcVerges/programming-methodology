...
float testAfegeixNota(Assignatura& assignatura)
{
    ...
    cout << "Comment :=>>" << endl;
    cout << "Comment :=>> -----------------------------------------------" << endl;
    cout << "Comment :=>> Test del m�tode afegeixNota " << endl;
    cout << "Comment :=>> -----------------------------------------------" << endl;
...
float testCalculaNotaMitjana(Assignatura& assignatura)
{
    ...
    cout << "Comment :=>>" << endl;
    cout << "Comment :=>> -----------------------------------------------" << endl;
    cout << "Comment :=>> Test del m�tode calculaNotaMitjana " << endl;
    cout << "Comment :=>> -----------------------------------------------" << endl;
...
int main()
{
    ...
    cout << "Comment :=>> Inicialitzem l'assignatura amb els estudiants seg�ents...." << endl;
